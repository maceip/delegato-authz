...
// `DekegatoAuthorization` will be the entrypoint for the contract.
sol_storage! {
    #[entrypoint]
    pub struct DekegatoAuthorization {
...
// Declare that `DekegatoAuthorization` is a contract with the following external methods.
#[external]
impl DekegatoAuthorization {
